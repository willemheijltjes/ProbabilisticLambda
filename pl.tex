...
\begin{definition}[Order for labels]\label{def:orderlabels}
  ...
  \fbox{
    \begin{minipage}{.97\textwidth}
      \begin{tabular}{ll}        
        ...
        \infer{\labjudg{\theta}{\trm{!a.M}}}{\labjudg{a,\theta}{M}}
        $$
        \end{minipage}
        \\
      \end{tabular}
...
\begin{lemma}\label{lemma:cloredsum}
...
\begin{proof}
  ...
  \item
    If reduction happens at the leftmost component $\trm{M +a N}$
    due to the rule $\trm{(P +b Q) +a R}\rw_\prob \trm{(P +a R) +b (Q +b R)}$,
...
\begin{proof}
  ...
  $$
  \trm{!b.(N +a M)}\rw_\prob\trm{(!b.N) +a (!b.M)}.
  $$
\end{proof}

Lemma 3.2 continues to hold, but requires a new proof. 
...
\begin{proof}
	On labeled terms, $\rw_\prob \,\subseteq\, \rwb_\prob \,\subseteq\, \rws_\prob$ and hence $\rwbs_\prob \,=\, \rws_\prob$.

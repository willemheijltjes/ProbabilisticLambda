...
possibly applications and not necessarily $\beta$-normal (unlike \cite{DalLagoZorzi12}, so that our $\rw_{\beta\val}$ is actually $\beta$-reduction on deterministic terms). 
%
